...
(define/contract (safe-if p c a)
  (-> boolean? any/c any/c any/c)
  (if p c a))

(define/contract (safe-or x y)
  (-> boolean? boolean? boolean?)
  (or x y))

(define/contract (safe-and x y)
  (-> boolean? boolean? boolean?)
  (and x y))

(define/contract (safe-eq? x y)
